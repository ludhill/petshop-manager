...
SECRET_KEY = 'django-insecure-_#&sd_1^x06n2#v1f-@gyga$ni^zkwq-#7@%)x6&qyqv$-^+q%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
#DEBUG = FALSE #PARA TESTE
...
LANGUAGE_CODE = 'pt-br'  # Alterado de 'en-us'

TIME_ZONE = 'America/Sao_Paulo' # Alterado de 'UTC'
